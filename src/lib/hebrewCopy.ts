...
export const changeReview = {
  ...
  none: 'אין כרגע בקשות הממתינות לאישורך.',
  pickTitle: 'בחר בקשה לבדיקה',
  requestedBy: 'הוגש על ידי',
  currentSlot: 'מיקום נוכחי',
  proposedSlot: 'מיקום מבוקש',
  reviewCta: 'בדיקה ואישור',
  flexTitle: 'רמת הגמישות של הרכיב',
  flexLockedShared:
    'זהו רכיב משותף נעול (אינו גמיש). הזזתו משפיעה על כל ההכשרות המקושרות ומחייבת את אישור כל המפקדים.',
  flexNoConflicts: 'המעבר למועד המבוקש אינו יוצר התנגשויות חדשות בטיוטה שלך.',
  flexFlexibleOnly:
    'ההתנגשויות שנוצרות הן מול רכיבים גמישים בלבד — ניתן להזיז אותם אוטומטית למועד פנוי סמוך.',
  flexHard: 'המעבר מתנגש עם רכיבים קשיחים. יידרש שיבוץ ידני או תיאום לפני האישור.',
  impactTitle: 'ניתוח השפעה מלא',
  solutionsTitle: 'אפשרויות פעולה',
  optApproveTitle: 'אישור הבקשה',
  optApproveDesc: (slot: string) =>
    `הרכיב יעבור ל-${slot} בטיוטה שלך ובכל ההכשרות המקושרות. השינוי לא יוצג לחיילים עד שתפרסם את הלו״ז.`,
  optApproveClean: 'המעבר אינו יוצר התנגשויות חדשות — ניתן לאשר בבטחה.',
  optApproveConflicts: (n: number) =>
    `המעבר יוצר ${n} התנגשויות חדשות בטיוטה. ניתן לפתור אותן במרכז הקונפליקטים לאחר האישור.`,
  optApproveCta: 'אישור הבקשה',
  optAutoTitle: 'אישור עם פתרון אוטומטי',
  optAutoDesc: (n: number) =>
    `אישור הבקשה, ולאחריו הזזת ${n} הרכיבים הגמישים המתנגשים למועד פנוי סמוך. רכיבים קשיחים לא יוזזו.`,
  optAutoCta: 'אישור ומעבר לפתרון',
  optRejectTitle: 'דחיית הבקשה',
  optRejectDesc:
    'הרכיב יישאר במיקומו הנוכחי. הבקשה תיתקע ותידרש היוועצות ישירה מול מגיש הבקשה לפני כל שינוי.',
  optRejectContact: (name: string, phone: string) => `ניתן ליצור קשר עם ${name} בטלפון ${phone}.`,
  optRejectCta: 'דחיית הבקשה',
  approvedToast: 'הבקשה אושרה והשינוי הוחל על הטיוטה. יש לפרסם כדי להציג לחיילים.',
  rejectedToast: 'הבקשה נדחתה. מומלץ ליצור קשר עם מגיש הבקשה לתיאום.'
} as const

export const prayersCopy = {
  title: 'לו״ז תפילות בבה״ד',
  subtitle: 'זמני התפילות הקבועים בבסיס',
  shacharit: 'שחרית',
  shacharitMusaf: 'שחרית ומוסף',
  mincha: 'מנחה',
  arvit: 'ערבית',
  selichot: 'סליחות',
  summerClock: 'שעון קיץ',
  winterClock: 'שעון חורף',
  clockNote: 'זמני מנחה וערבית מתעדכנים אוטומטית לפי שעון קיץ/חורף.',
  roshChodeshNote: 'בראש חודש שחרית ארוכה יותר.',
  elulNote: 'בחודש אלול נוספות סליחות.',
  noPrayersShabbat: 'שבת — אין זמני תפילה קבועים בלו״ז זה.',
  photoAlt: 'חייל בתפילה עם טלית ותפילין בשקיעה',

  instructionsTitle: 'הנחיות כלליות לתפילות',
  instructionsTab: 'זמני התפילות בבה״ד',
  instructions: [
    { label: 'שחרית — ימי חול', value: '06:30–07:10' },
    { label: 'שחרית — יום חמישי', value: '06:15–07:10' },
    { label: 'שחרית — ראש חודש', value: '06:30–07:30 · בחמישי 06:15–07:15' },
    { label: 'מנחה — שעון קיץ', value: '13:15–13:40' },
    { label: 'ערבית — שעון קיץ', value: '21:45–22:05' },
    { label: 'מנחה — שעון חורף', value: '12:45–13:10' },
    { label: 'ערבית — שעון חורף', value: '19:00–19:20' },
    { label: 'סליחות — חודש אלול', value: '05:50 לפני שחרית · 12:40 לפני מנחה' },
    { label: 'שבת', value: 'אין זמנים קבועים בלו״ז זה' }
  ],

  ordersTitle: 'פקודות מטכ״ל — שירות חיילים דתיים',
  ordersNote: 'תקציר בלבד. הנוסח המחייב מופיע בפקודות מטכ״ל.',
  orders: [
    'מפקדים יאפשרו זמן לשלוש התפילות ולהנחת תפילין, ככל שהמשימה מאפשרת.',
    'המזון בבסיס כשר; אין לחייב חייל לאכול ממקור שאינו כשר.',
    'אין לחייב חילול שבת וחג, למעט צורך מבצעי או פיקוח נפש.',
    'כיסוי ראש וציצית מותרים בהתאם להוראות הלבוש.',
    'בימי צום תתבצע התחשבות במאמץ הפיזי ובעומס האימונים.',
    'פנייה בנושאי דת מופנית לרב היחידה או לקצין הדת.'
  ]
} as const
